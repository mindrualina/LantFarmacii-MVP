    ...
    internal class UtilizatorRepository
    {
            ...
            try
            {
                ...
                foreach (XElement xElem in lista)
                {
                    ...
                    if (nrLeg == legitimatie)
                    {
                        ...
                        Utilizator ut = new Utilizator(nume, nrLeg, cont, parola, rol);
                        return ut;
                    }
                }
                return null;
        ...
        public bool ActualizareUtilizator(uint nrLegitimatie, Utilizator ut)
        {
            try
            {
                ...
                if (ut.AccesLegitimatie() != 0)
                    element.Element("legitimatie").Value = ut.AccesLegitimatie().ToString();
            ...
            try
            {
                ...
                foreach (XElement xElem in lista)
                {
                    ...
                    if (userXML == nume && parolaXML == parola)
                    {
                        ...
                        Utilizator utilizator = new Utilizator(numeXML, legitimatieXML, userXML, parolaXML, rolXML);
